...
public class DeliveryDAO {
	...
	public List<Delivery> qiyeQueryDelivery(String qiyeUserName) {
		List<Delivery> deliveryList = new ArrayList<Delivery>();
		DB db = new DB();
		String sql = "select Delivery.* from Delivery,Job where Delivery.jobObj=Job.jobId and Job.qiyeObj='" + qiyeUserName + "'";
