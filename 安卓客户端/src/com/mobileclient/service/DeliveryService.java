...
public class DeliveryService {
	...
	/* 企业查询本公司职位投递 */
	public List<Delivery> qiyeQueryDelivery(String qiyeUserName) throws Exception {
		String urlString = HttpUtil.BASE_URL + "DeliveryServlet?action=qiyeQuery";
		urlString += "&qiyeUserName=" + qiyeUserName; 
		List<Delivery> deliveryList = new ArrayList<Delivery>();
		byte[] resultByte;
		try {
			resultByte = HttpUtil.SendPostRequest(urlString, null, "UTF-8");
