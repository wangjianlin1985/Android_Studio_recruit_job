...
public class JobQiyeEditActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_qiyeObj.setVisibility(View.GONE);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_positionName.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "招聘职位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_personNum.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "招聘人数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_city.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "所在城市输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_salary.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "薪资待遇输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workYears.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "工作年限输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workAddress.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "工作地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_welfare.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "福利待遇输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_positionDesc.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "岗位要求输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_connectPerson.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "联系人输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(JobQiyeEditActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传职位信息*/
					JobQiyeEditActivity.this.setTitle("正在更新职位信息，稍等...");
