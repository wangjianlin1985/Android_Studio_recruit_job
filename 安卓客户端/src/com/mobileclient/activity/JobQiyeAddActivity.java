...
public class JobQiyeAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.job_qiye_add); 
		...
		btnAdd.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					Declare declare = (Declare) JobQiyeAddActivity.this.getApplication();
					job.setQiyeObj(declare.getUserName());
					
					/*验证获取招聘职位*/ 
					if(ET_positionName.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "招聘职位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_personNum.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "招聘人数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_city.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "所在城市输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_salary.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "薪资待遇输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workYears.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "工作年限输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workAddress.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "工作地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_welfare.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "福利待遇输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_positionDesc.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "岗位要求输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_connectPerson.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "联系人输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(JobQiyeAddActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传职位信息*/
					JobQiyeAddActivity.this.setTitle("正在上传职位信息，稍等...");
