...
public class JobWantUserAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.jobwant_user_add); 
		...
		spinner_userObj.setVisibility(View.GONE);
		...
		btnAdd.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					Declare decalre = (Declare) JobWantUserAddActivity.this.getApplication();
					jobWant.setUserObj(decalre.getUserName());
					/*验证获取职位名称*/ 
					if(ET_positionName.getText().toString().equals("")) {
						Toast.makeText(JobWantUserAddActivity.this, "职位名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_salary.getText().toString().equals("")) {
						Toast.makeText(JobWantUserAddActivity.this, "期望薪资输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workCity.getText().toString().equals("")) {
						Toast.makeText(JobWantUserAddActivity.this, "工作地点输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_wantMemo.getText().toString().equals("")) {
						Toast.makeText(JobWantUserAddActivity.this, "备注说明输入不能为空!", Toast.LENGTH_LONG).show();
					...
					jobWant.setAddTime("");
					/*调用业务逻辑层上传求职信息*/
					JobWantUserAddActivity.this.setTitle("正在上传求职信息，稍等...");
